...
c3dl.EffectTemplate = function()
{
	...
	*/
	this.init = function()
	{
		...
		if(	this.isInitialized == false)
		{
			...
			// is optional.
			if(	this.renderingCB && this.vertexShaders.length > 0 && 
				this.fragmentShaders.length > 0)
			{
	...
	*/
	this.toString = function(delimiter)
	{
		...
		return	"Initialized = " + this.isInitialized + delimiter + 
				"Vertex Shaders = " + this.vertexShaders + delimiter +
				"Fragment Shaders = " + this.fragmentShaders + delimiter +
				"Rendering Callback = " + this.renderingCB + delimiter +
