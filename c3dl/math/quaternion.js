...
/**
 ...
 @param {Array} quat - The object to be checked.
...
/**
 ...
 @param {float} newW - The W value for the quaternion
 @param {float} newX - The X value for the quaternion
 @param {float} newY - The Y value for the quaternion
 @param {float} newZ - The Z value for the quaternion
...
/**
 ...
 @param {Array} quat - The quaternion the data will be copied from
 @param {Array} dest - The matrix the data will be placed in.
...
/**
 Use a quaternion to calculate an axis to rotate around and a scalar amount to rotate around it
 
 @param {Array} axisVec - The array to store the axis in
 @param {float} angleScalar - The amount to rotate around that array.
 */
...
/**
 ...
 @param {Array} axisVec - The axis the rotation is based around.
 @param {float} angleScalar - The amount to rotate around that axis.
 @param {Array} dest - The quaternion to hold the rotation
 
 @returns {Array} The quaternion to hold the rotation
...
/**
 ...
 @param {Array} newMat - The matrix to turn into a quaternion
 
 @returns {Array} The resulting quaternion
 */
...
/**
 Get the length of the quaternion, squared.
 
 @param {Array} quat - The quaternion to ontain the squared length of
 
 @returns {float} - The squared length of the quaternion
 */
...
/**
 ...
 @param {Array} quat - The quaternion to obtain the length of
...
/**
 ...
 @param {Array} quatOne - One quaternion to add
 @param {Array} quatTwo - The other quaternion to add
...
/**
 ...
 @param {Array} quatOne - The quaternion to subtract from
 @param {Array} quatTwo - The quaternion to subtract
 
 @returns {Array} The quaternion that results from subtracting 'quatTwo' from 'quatOne'.
 */
...
/**
 ...
 @param {Array} quatOne - The quaternion to multiply
 @param {float} scalar - The scalar to multiply it by.
 
 @return {Array} The quaternion generated by multiplying 'quatOne' by 'scalar'.
 */
...
/**
 ...
 @param {Array} quat - The quaternion to obtain the conjugate of.
 
 return {Array} - A new quaternion holding the conjugate of 'quat'
 */
...
/**
 ...
 @param {Array} quat - The quaternion to obtain a normalized copy of.
 
 @return {Array} A new quaternion containing the value of 'quat' normalized.
 */
...
/**
 ...
 @return {Array} A new quaternion containing the inverse value of 'quat'
 */
