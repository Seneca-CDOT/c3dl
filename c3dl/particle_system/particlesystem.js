  ...
  this.maxSize = 1;
	...
	*/
	this.setDstBlend = function(dstBlend)
	{
		switch(dstBlend)
		{
			case c3dl.ZERO:		case c3dl.ONE:
			case c3dl.SRC_COLOR:	case c3dl.ONE_MINUS_SRC_COLOR:
			case c3dl.SRC_ALPHA:	case c3dl.ONE_MINUS_SRC_ALPHA:
			case c3dl.DST_ALPHA:	case c3dl.ONE_MINUS_DST_ALPHA:
			case c3dl.DST_COLOR:	case c3dl.ONE_MINUS_DST_COLOR:
		...
		for(var i = 0; i < this.particles.length; i++)
		{
			...
			if(this.particles[i].isAlive())
			{
				...
				this.particles[i].setVelocity([
												vel[0] + (this.acceleration[0] * timeInSeconds),
												vel[1] + (this.acceleration[1] * timeInSeconds),
