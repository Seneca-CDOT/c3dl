...
c3dl.OBB = function ()
{
  ...
  {
  	for (var i = 0; i <8; i++) {
      this.boxverts[i] = c3dl.multiplyMatrixByVector(c3dl.inverseMatrix(this.getTransform()), this.boxverts[i]);
	  }
    ...
    for (var i = 0; i <8; i++) {
      this.boxverts[i] = c3dl.multiplyMatrixByVector(this.getTransform(), this.boxverts[i]);
    }
  }
