...
c3dl.Material = function()
{
  ...
  */
  this.toString = function()
  {
    ...
    return  "Name: "      + this.getName()     + breakStr +
            "Emission: "  + this.getEmission() + breakStr +
            "Ambient: "   + this.getAmbient()  + breakStr + 
            "Diffuse: "   + this.getDiffuse()  + breakStr +
            "Specular: "  + this.getSpecular() + breakStr +
