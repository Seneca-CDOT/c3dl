...
function toggle() {
if (teapot1.drawObb) {
teapot1.setDrawObb(false);
teapot2.setDrawObb(false);
teapot3.setDrawObb(false);
}
else {
teapot1.setDrawObb(true);
teapot2.setDrawObb(true);
teapot3.setDrawObb(true);
}
}