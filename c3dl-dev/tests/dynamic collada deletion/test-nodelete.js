//Dynamic Collada Deletion Test

//This page (in conjuntion with test.js) tests the fps changes
//when an object is removed from the scene, vs when it is also
//deleted.
...
// This object is then removed from the scene.
