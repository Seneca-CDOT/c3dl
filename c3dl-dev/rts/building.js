...
function Building(maxOccupants, maxHealth, path,type, repairTime, cost){
	//homes only
  ...
  this.isPlaced          = false;  //has the building been placed into the map.
  this.cost              = cost;
}
...
Building.prototype.setPlacement = function(position){
	if(this.collada)
	{
    this.isPlaced = true;
